/**
 * /platform/shipments/[id] — single shipment detail + AES filing tracker (AI-12006).
 *
 * Server component. Loads the shipment directly from the database and renders
 * details + the AESFilingTracker (client component for inline editing).
 *
...
export default async function ShipmentDetailPage({
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      ...
      {/* AES Filing Tracker (AI-12006) */}
      <AESFilingTracker
        shipmentId={shipment.id}
        aesStatus={shipment.aesStatus}
        aesNumber={shipment.aesNumber}
        aceDeepLink={shipment.aceDeepLink}
      />
