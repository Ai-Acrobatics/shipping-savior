...
export default function FTZAnalyzerPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section id="pfnpf" className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold text-navy-900">PF vs NPF Status Election + Tariff Scenarios</h2>
              </div>
          ...
          <ScrollReveal>
            <div className="bg-white border border-purple-100 rounded-2xl p-6 shadow-card">
              <div className="mb-6">
                <p className="text-sm text-navy-500 leading-relaxed">
                  Compare <strong className="text-ocean-600">Privileged Foreign (PF)</strong> vs{" "}
                  <strong className="text-emerald-600">Non-Privileged Foreign (NPF)</strong> zone
        ...
        <div className="max-w-5xl mx-auto">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <div className="text-xs text-green-400 font-medium mb-0.5">STEP 4</div>
