...
export const dashboardShipments: DashboardShipment[] = [
  {
    ...
    timeline: [
      ...
      { event: "Transshipment", location: "Singapore", timestamp: "Apr 5, 2026", status: "completed", details: "Transferred to MSC ANNA" },
      { event: "Arrived at port", location: "Long Beach", timestamp: "Apr 23, 2026", status: "completed" },
      { event: "Customs cleared", location: "Long Beach CBP", timestamp: "Apr 24, 2026", status: "completed" },
      { event: "Delivered to FTZ", location: "FTZ #50 — Long Beach", timestamp: "Apr 26, 2026", status: "completed" },
    ],
    alerts: [],
    temperature: {
      current: -18.2,
  ...
  },
  {
    ...
    volume: "58 CBM",
    timeline: [
      { event: "Booking confirmed", location: "Bangkok", timestamp: "Apr 8, 2026", status: "completed" },
      { event: "Container loaded", location: "Laem Chabang", timestamp: "Apr 13, 2026", status: "completed" },
      { event: "Vessel departed", location: "THLCH", timestamp: "Apr 14, 2026", status: "completed" },
      { event: "Transshipment", location: "Singapore", timestamp: "Apr 18, 2026", status: "completed", details: "Transferred to OOCL TOKYO" },
      { event: "Pacific crossing", location: "At sea", timestamp: "Apr 26, 2026", status: "current" },
      { event: "Arrive at port", location: "Long Beach", timestamp: "May 6, 2026", status: "upcoming" },
      { event: "Customs clearance", location: "Long Beach CBP", timestamp: "May 8, 2026", status: "upcoming" },
    ],
    alerts: [],
    costs: {
      freight: 4800,
  ...
  },
  {
    ...
    containerType: "40ft HC",
    cargoType: "general",
    eta: "May 18, 2026 (was Apr 12)",
    etd: "Apr 18, 2026",
    value: "$215,600",
    weight: "64,800 kg",
    volume: "172 CBM",
    timeline: [
      { event: "Booking confirmed", location: "Jakarta", timestamp: "Apr 10, 2026", status: "completed" },
      { event: "Container loaded", location: "Tanjung Priok", timestamp: "Apr 17, 2026", status: "completed" },
      { event: "Vessel departed", location: "IDJKT", timestamp: "Apr 18, 2026", status: "completed" },
      { event: "Weather delay", location: "South China Sea", timestamp: "Apr 23, 2026", status: "current", details: "Typhoon avoidance reroute — 6 day delay" },
      { event: "Arrive at port", location: "Los Angeles", timestamp: "May 16, 2026", status: "upcoming" },
      { event: "Customs clearance", location: "LA/Long Beach CBP", timestamp: "May 18, 2026", status: "upcoming" },
    ],
    alerts: [
      {
        id: "alert-1",
        ...
        severity: "warning",
        timestamp: "Apr 23, 2026 14:30 UTC",
        resolved: false,
      },
    ],
    costs: {
  ...
  },
  {
    ...
    timeline: [
      ...
      { event: "Transshipment", location: "Colombo, Sri Lanka", timestamp: "Apr 4, 2026", status: "completed" },
      { event: "Arrived at port", location: "Port Newark", timestamp: "Apr 25, 2026", status: "completed" },
      { event: "Customs inspection", location: "Newark CBP", timestamp: "Apr 26, 2026", status: "current", details: "Random CBP exam in progress" },
      { event: "Release & delivery", location: "Newark, NJ", timestamp: "Apr 28, 2026", status: "upcoming" },
    ],
    alerts: [
      {
        id: "alert-2",
        ...
        severity: "info",
        timestamp: "Apr 26, 2026 09:00 UTC",
        resolved: false,
      },
    ],
    costs: {
  ...
  },
  {
    ...
    timeline: [
      ...
      { event: "Container loaded", location: "Qianwan Container Terminal", timestamp: "Apr 3, 2026", status: "completed" },
      { event: "Vessel departed", location: "CNTAO", timestamp: "Apr 4, 2026", status: "completed" },
      { event: "Arrived at port", location: "Long Beach", timestamp: "Apr 25, 2026", status: "completed" },
      { event: "Awaiting customs", location: "Long Beach", timestamp: "Apr 26, 2026", status: "current", details: "Pending ISF validation" },
      { event: "Delivery to FTZ", location: "FTZ #50 — Long Beach", timestamp: "Apr 27, 2026", status: "upcoming" },
    ],
    alerts: [],
    costs: {
      freight: 6400,
  ...
  },
  {
    ...
    volume: "124 CBM",
    timeline: [
      { event: "Booking confirmed", location: "Ho Chi Minh City", timestamp: "Apr 24, 2026", status: "completed" },
      { event: "Container pickup", location: "Supplier warehouse", timestamp: "May 7, 2026", status: "upcoming" },
      { event: "Vessel departure", location: "VNCLI", timestamp: "May 10, 2026", status: "upcoming" },
...
export const notifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Monthly storage invoice for Long Beach FTZ available. $2,340 for April 2026.",
    type: "cost",
    severity: "info",
  ...
  },
  {
    ...
    message: "Scheduled maintenance window: Apr 30, 2–4 AM UTC. Brief disruption expected.",
    type: "system",
    severity: "info",
...
export const activityFeed: ActivityEvent[] = [
  { id: "af1", type: "delivery_confirmed", title: "MSCU-4821937 delivered to FTZ #50", description: "Container cleared CBP and moved to Free Trade Zone warehouse", timestamp: "Apr 26, 08:30", shipmentId: "MSCU-4821937" },
  { id: "af2", type: "customs_cleared", title: "Customs clearance complete", description: "CBP inspection passed — no holds", timestamp: "Apr 24, 16:00", shipmentId: "MSCU-4821937" },
  { id: "af3", type: "cost_alert", title: "CMA CGM delay surcharge possible", description: "Weather reroute may trigger $800/container surcharge", timestamp: "Apr 23, 15:00", shipmentId: "CMAU-5529817" },
  { id: "af4", type: "status_change", title: "OOLU-7391024 passed Singapore", description: "Container transshipped at Singapore, now on OOCL TOKYO", timestamp: "Apr 18, 12:00", shipmentId: "OOLU-7391024" },
  { id: "af5", type: "document_uploaded", title: "ISF filed for EISU-6017293", description: "Importer Security Filing submitted to CBP", timestamp: "Apr 15, 09:15", shipmentId: "EISU-6017293" },
  { id: "af6", type: "shipment_created", title: "New booking: Maersk HCMC → Savannah", description: "2x 40ft Reefer containers, cold chain. ETD Apr 10.", timestamp: "Apr 24, 14:30", shipmentId: "MAEU-9304712" },
  { id: "af7", type: "rate_quote", title: "Rate locked: Maersk HCMC → Savannah", description: "$4,200/40ft HC — 8% below market rate", timestamp: "Apr 21, 10:00" },
  { id: "af8", type: "partner_update", title: "FTZ #50 capacity update", description: "Long Beach FTZ at 72% capacity — 280 pallet positions available", timestamp: "Apr 20, 08:00" },
];
